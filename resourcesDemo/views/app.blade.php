...
<div style="max-width: 420px; width: 100%;">
    <div class="header"
         style="position: fixed;padding: 6px; top: 0;max-width: 420px; width: 100%;  z-index: 11; background-color: #EB192B;font-size: 24px;font-weight: 600; color: #FFFFFF">
    ...
    @if(isset($attendance_recorder) and $attendance_recorder==1)
        
    @else
        <div class="fixed bottom-0 max-w-[420px] w-full z-20">
            <form id="actionForm" method="POST" class="flex justify-around gap-4 items-center px-4 py-1 bg-[#EB192B] text-[25px]" style="padding: 15px 0 10px 0">
                @csrf
                @if(isset($_COOKIE['token_0']) || isset($_COOKIE['token_1']) || isset($_COOKIE['token_2']))

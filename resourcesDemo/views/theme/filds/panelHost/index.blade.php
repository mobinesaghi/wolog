    ...
    <div class="container"
        ...
        <form action="{{url('make/host')}}" method="post">@csrf
            <div class="card" style="padding-right: 20px">
                <a class="singup textfa">اضافه کردن دعوت کنندگان</a>
                <div class="inputBox1">
                ...
                <div class="inputBox1">
                    <input type="text" name="from" required="required"
                           style="font-family: 'Baloo Bhaijaan 2', cursive;text-align: left">
                    <span class="user textfa">از شماره</span>
                </div>
                <div class="inputBox1">
                    <input type="text" name="to" required="required"
                           style="font-family: 'Baloo Bhaijaan 2', cursive;text-align: left">
                    <span class="user textfa">تا</span>
                </div>
            ...
            <a href="{{url("go_down/$item->id")}}">
                <button class="callbutton custom-button" style="font-family: 'Baloo Bhaijaan 2', cursive;">
                    ...
                    <div style="display: flex">
                        <label style="background: black; color: #FFFFFF;border-radius: 6px;padding: 20px 5px 20px 5px; margin-top: -30px">{{$item->from}}->{{$item->to}}</label> <!-- مقدار رنج -->

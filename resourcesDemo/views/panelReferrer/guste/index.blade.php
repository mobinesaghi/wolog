...
@section('content')
    ...
    <div class="container"
        ...
        <form class="form" action="{{url('make/host')}}" method="post" style="text-align: left">@csrf
            ...
            <div class="radio-input" style="width: 100%;">
                <label>
                    <input type="radio" name="value-radio" value="boy">
                    <span>پسر</span>
                </label>
                <label>
                    <input type="radio" name="value-radio" value="man" CHECKED>
                    <span>اقا</span>
                </label>
                <label>
                    <input type="radio" name="value-radio" value="woman">
                    <span>خانم</span>
                </label>
                <label>
                    <input type="radio" name="value-radio" value="girl">
                    <span>دختر</span>
                </label>
            ...
            <div class="" style="display: flex;justify-content: space-around;">
                ...
                <button class="submit">خانواده</button>
            </div>

            <label style="background: #424e54;border-radius: 10px; padding: 12px; color: #fff; text-align: center"
                   onclick="getContacts()">از مخاطبین</label>
        </form>
    ...
    {{--    <div class="form-container"  style="margin-bottom: 50px; border-radius: 23px;">--}}
                    ...
                    @foreach($user->Users->sortBy('to') as $item)
                        <tr class="hover:bg-red-100 cursor-pointer"
                            ...
                            <td class="py-4 px-6 text-sm text-gray-900 whitespace-nowrap text-right"
                                style="color: #000000 !important;font-weight:600 ">{{$item->name}}</td>
